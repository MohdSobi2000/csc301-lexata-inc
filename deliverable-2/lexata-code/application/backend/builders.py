"""
A class providing methods to build entity objects (RiskFactors, Filings, Companies) from dictionaries containing data.
If a dictionary has missing information, the build operation will return None. Allows the support of optional fields.
