...
# Embed short descriptions of each label (env, nonenv), then compare 
# cosine distance between embeddings of samples and label descriptions.
# The highest similarity label to the sample input is the predicted 
# label.
